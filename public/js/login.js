...
$(".githublogin").click(function (e) {
    window.location="https://github.com/login/oauth/authorize?client_id=a5a36494dfb0fa76a60b&redirect_uri=http://www.yangtengfei.cn/login/githubLogin&scope=user&state=any";
